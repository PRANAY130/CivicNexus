...
import { BadgeHelp, CheckCircle, LineChart as LineChartIcon, Shield, ShieldAlert, Trophy } from 'lucide-react';
...
export default function SupervisorAnalyticsPage() {
        ...
        if (!storedUser) {
            ...
            const unsubscribe = onSnapshot(ticketsQuery, (snapshot) => {
                const ticketsData = snapshot.docs.map(doc => {
                    ...
                    return { ...data, id: doc.id, submittedDate } as Ticket;
                });
    ...
    return (
        <div className="space-y-6 p-4 md:p-6">
            <h1 className="text-3xl font-bold tracking-tight font-headline flex items-center gap-2"><LineChartIcon className="h-8 w-8 text-primary"/> My Analytics</h1>
             <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
